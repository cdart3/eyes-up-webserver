...
gulp.task("react-build-iso", function() {
	return $.gulpSequence(["rt"]["react-browserify"],["uglify"])(function() {
...
gulp.task("watch", (['react-build-iso','browserify','rt','uglify']), function() {
...
gulp.task('default', ['react-build-iso','browserify','rt','uglify']);
